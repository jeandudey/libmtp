...
static inline void htod64ap(PTPParams *params, unsigned char *a, uint64_t val) {
    if (params->byteorder == PTP_DL_LE)
        htole64a(a, val);
    else
        htobe64a(a, val);
...
static inline uint64_t dtoh64p(PTPParams *params, uint64_t var) {
    return ((params->byteorder == PTP_DL_LE) ? le64toh(var) : be64toh(var));
}

static inline uint16_t dtoh16ap(PTPParams *params, const unsigned char *a) {
    return ((params->byteorder == PTP_DL_LE) ? le16atoh(a) : be16atoh(a));
}

static inline uint32_t dtoh32ap(PTPParams *params, const unsigned char *a) {
    return ((params->byteorder == PTP_DL_LE) ? le32atoh(a) : be32atoh(a));
}

static inline uint64_t dtoh64ap(PTPParams *params, const unsigned char *a) {
...
static inline char *ptp_unpack_string(PTPParams *params, unsigned char *data,
    ...
    *len = length;
    ...
    if (params->cd_ucs2_to_locale != (iconv_t)-1)
        nconv =
            iconv(params->cd_ucs2_to_locale, &src, &srclen, &dest, &destlen);
...
static inline int ucs2strlen(uint16_t const *const unicstr) {
    int length = 0;
...
static inline void ptp_pack_string(PTPParams *params, char *string,
                                   unsigned char *data, uint16_t offset,
                                   uint8_t *len) {
    int packedlen = 0;
    ...
    if (params->cd_locale_to_ucs2 != (iconv_t)-1) {
        ...
        nconv = iconv(params->cd_locale_to_ucs2, &stringp, &convlen, &ucs2strp,
                      &convmax);
        if (nconv == (size_t)-1)
            ucs2str[0] = 0x0000U;
    } else {
...
static inline unsigned char *ptp_get_packed_stringcopy(PTPParams *params,
                                                       char *string,
...
static inline uint32_t ptp_unpack_uint32_t_array(PTPParams *params,
                                                 unsigned char *data,
                                                 uint16_t offset,
                                                 uint32_t **array) {
    uint32_t n, i = 0;
...
static inline uint32_t ptp_pack_uint32_t_array(PTPParams *params,
                                               uint32_t *array,
                                               uint32_t arraylen,
                                               unsigned char **data) {
    uint32_t i = 0;
...
static inline uint32_t ptp_unpack_uint16_t_array(PTPParams *params,
                                                 unsigned char *data,
                                                 uint16_t offset,
                                                 uint16_t **array) {
    uint32_t n, i = 0;
...
static inline void ptp_unpack_DI(PTPParams *params, unsigned char *data,
                                 PTPDeviceInfo *di, unsigned int datalen) {
    uint8_t len;
    ...
    di->VendorExtensionDesc =
        ptp_unpack_string(params, data, PTP_di_VendorExtensionDesc, &len);
    totallen = len * 2 + 1;
    di->FunctionalMode = dtoh16a(&data[PTP_di_FunctionalMode + totallen]);
    di->OperationsSupported_len = ptp_unpack_uint16_t_array(
        params, data, PTP_di_OperationsSupported + totallen,
        &di->OperationsSupported);
    totallen = totallen + di->OperationsSupported_len * sizeof(uint16_t) +
               sizeof(uint32_t);
    di->EventsSupported_len = ptp_unpack_uint16_t_array(
        params, data, PTP_di_OperationsSupported + totallen,
        &di->EventsSupported);
    totallen = totallen + di->EventsSupported_len * sizeof(uint16_t) +
               sizeof(uint32_t);
    di->DevicePropertiesSupported_len = ptp_unpack_uint16_t_array(
        params, data, PTP_di_OperationsSupported + totallen,
        &di->DevicePropertiesSupported);
    totallen = totallen + di->DevicePropertiesSupported_len * sizeof(uint16_t) +
               sizeof(uint32_t);
    di->CaptureFormats_len = ptp_unpack_uint16_t_array(
        params, data, PTP_di_OperationsSupported + totallen,
        &di->CaptureFormats);
    totallen =
        totallen + di->CaptureFormats_len * sizeof(uint16_t) + sizeof(uint32_t);
    di->ImageFormats_len = ptp_unpack_uint16_t_array(
        params, data, PTP_di_OperationsSupported + totallen, &di->ImageFormats);
    totallen =
        totallen + di->ImageFormats_len * sizeof(uint16_t) + sizeof(uint32_t);
    di->Manufacturer = ptp_unpack_string(
        params, data, PTP_di_OperationsSupported + totallen, &len);
    totallen += len * 2 + 1;
    di->Model = ptp_unpack_string(params, data,
                                  PTP_di_OperationsSupported + totallen, &len);
    totallen += len * 2 + 1;
    di->DeviceVersion = ptp_unpack_string(
        params, data, PTP_di_OperationsSupported + totallen, &len);
    totallen += len * 2 + 1;
    di->SerialNumber = ptp_unpack_string(
        params, data, PTP_di_OperationsSupported + totallen, &len);
}
...
inline static void ptp_free_DI(PTPDeviceInfo *di) {
    ...
    if (di->CaptureFormats)
        free(di->CaptureFormats);
    if (di->VendorExtensionDesc)
        free(di->VendorExtensionDesc);
    if (di->OperationsSupported)
        free(di->OperationsSupported);
    if (di->EventsSupported)
...
static inline void ptp_unpack_EOS_DI(PTPParams *params, unsigned char *data,
    ...
    di->EventsSupported_len =
        ptp_unpack_uint32_t_array(params, data, totallen, &di->EventsSupported);
    if (!di->EventsSupported)
        return;
    ...
    di->DevicePropertiesSupported_len = ptp_unpack_uint32_t_array(
        params, data, totallen, &di->DevicePropertiesSupported);
    if (!di->DevicePropertiesSupported)
        return;
    ...
    di->unk_len = ptp_unpack_uint32_t_array(params, data, totallen, &di->unk);
    if (!di->unk)
        return;
...
static inline void ptp_free_EOS_DI(PTPCanonEOSDeviceInfo *di) {
    free(di->EventsSupported);
    free(di->DevicePropertiesSupported);
    free(di->unk);
}
...
static inline void ptp_unpack_OH(PTPParams *params, unsigned char *data,
                                 PTPObjectHandles *oh, unsigned int len) {
    if (len) {
...
static inline void ptp_unpack_SIDs(PTPParams *params, unsigned char *data,
                                   PTPStorageIDs *sids, unsigned int len) {
    if (!data || !len) {
        sids->n = 0;
        sids->Storage = NULL;
        return;
...
static inline void ptp_unpack_SI(PTPParams *params, unsigned char *data,
                                 PTPStorageInfo *si, unsigned int len) {
    ...
    si->StorageDescription = ptp_unpack_string(
        params, data, PTP_si_StorageDescription, &storagedescriptionlen);
    si->VolumeLabel = ptp_unpack_string(
        params, data, PTP_si_StorageDescription + storagedescriptionlen * 2 + 1,
...
static inline uint32_t ptp_pack_OI(PTPParams *params, PTPObjectInfo *oi,
                                   unsigned char **oidataptr) {
...
/* the caller should free it after use! */
    ...
    ptp_pack_string(params, oi->Filename, oidata, PTP_oi_filenamelen,
                    &filenamelen);
/*
...
static time_t ptp_unpack_PTPTIME(const char *str) {
    ...
    if (ptpdatelen >= sizeof(ptpdate)) {
        /*ptp_debug (params ,"datelen is larger then size of buffer",
         * ptpdatelen, (int)sizeof(ptpdate));*/
        return 0;
    }
    if (ptpdatelen < 15) {
...
static inline void ptp_unpack_OI(PTPParams *params, unsigned char *data,
                                 PTPObjectInfo *oi, unsigned int len) {
    uint8_t filenamelen;
    ...
    if ((data[PTP_oi_filenamelen] == 0) &&
        (data[PTP_oi_filenamelen + 4] != 0)) {
        params->ocs64 = 1;
        data += 4;
    }
    ...
    oi->Filename =
        ptp_unpack_string(params, data, PTP_oi_filenamelen, &filenamelen);

    capture_date = ptp_unpack_string(params, data,
                                     PTP_oi_filenamelen + filenamelen * 2 + 1,
                                     &capturedatelen);
    ...
    capture_date =
        ptp_unpack_string(params, data, PTP_oi_filenamelen + filenamelen * 2 +
                                            capturedatelen * 2 + 2,
                          &capturedatelen);
...
ptp_unpack_DPV(PTPParams *params, unsigned char *data, unsigned int *offset,
               int total, PTPPropertyValue *value, uint16_t datatype) {
    switch (datatype) {
    case PTP_DTC_INT8:
...
static inline int ptp_unpack_DPD(PTPParams *params, unsigned char *data,
                                 PTPDevicePropDesc *dpd, unsigned int dpdlen) {
    ...
    ret = ptp_unpack_DPV(params, data, &offset, dpdlen,
                         &dpd->FactoryDefaultValue, dpd->DataType);
    if (!ret)
        goto outofmemory;
    if ((dpd->DataType == PTP_DTC_STR) && (offset == dpdlen))
        return 1;
    ret = ptp_unpack_DPV(params, data, &offset, dpdlen, &dpd->CurrentValue,
                         dpd->DataType);
    if (!ret)
        goto outofmemory;
    ...
    case PTP_DPFF_Range:
        ret = ptp_unpack_DPV(params, data, &offset, dpdlen,
                             &dpd->FORM.Range.MinimumValue, dpd->DataType);
        if (!ret)
            goto outofmemory;
        ret = ptp_unpack_DPV(params, data, &offset, dpdlen,
                             &dpd->FORM.Range.MaximumValue, dpd->DataType);
        if (!ret)
            goto outofmemory;
        ret = ptp_unpack_DPV(params, data, &offset, dpdlen,
                             &dpd->FORM.Range.StepSize, dpd->DataType);
        if (!ret)
            goto outofmemory;
        break;
...
#define N dpd->FORM.Enum.NumberOfValues
        ...
        dpd->FORM.Enum.SupportedValue =
            malloc(N * sizeof(dpd->FORM.Enum.SupportedValue[0]));
        if (!dpd->FORM.Enum.SupportedValue)
            goto outofmemory;

        memset(dpd->FORM.Enum.SupportedValue, 0,
...
static inline int ptp_unpack_Sony_DPD(PTPParams *params, unsigned char *data,
    ...
    *poffset = PTP_dpd_Sony_FactoryDefaultValue;
    ...
    if ((dpd->DataType == PTP_DTC_STR) && (*poffset == dpdlen))
        return 1;
    ret = ptp_unpack_DPV(params, data, poffset, dpdlen, &dpd->CurrentValue,
                         dpd->DataType);
    if (!ret)
        goto outofmemory;
...
static inline void duplicate_PropertyValue(const PTPPropertyValue *src,
                                           PTPPropertyValue *dst,
                                           uint16_t type) {
    if (type == PTP_DTC_STR) {
        if (src->str)
    ...
    if (type & PTP_DTC_ARRAY_MASK) {
        ...
        for (i = 0; i < src->a.count; i++)
            duplicate_PropertyValue(&src->a.v[i], &dst->a.v[i],
...
static inline void duplicate_DevicePropDesc(const PTPDevicePropDesc *src,
                                            PTPDevicePropDesc *dst) {
    int i;
    ...
    duplicate_PropertyValue(&src->FactoryDefaultValue,
                            &dst->FactoryDefaultValue, src->DataType);
    duplicate_PropertyValue(&src->CurrentValue, &dst->CurrentValue,
                            src->DataType);

    dst->FormFlag = src->FormFlag;
    switch (src->FormFlag) {
    case PTP_DPFF_Range:
        duplicate_PropertyValue(&src->FORM.Range.MinimumValue,
                                &dst->FORM.Range.MinimumValue, src->DataType);
        duplicate_PropertyValue(&src->FORM.Range.MaximumValue,
                                &dst->FORM.Range.MaximumValue, src->DataType);
        duplicate_PropertyValue(&src->FORM.Range.StepSize,
                                &dst->FORM.Range.StepSize, src->DataType);
        break;
    case PTP_DPFF_Enumeration:
        dst->FORM.Enum.NumberOfValues = src->FORM.Enum.NumberOfValues;
        dst->FORM.Enum.SupportedValue =
            malloc(sizeof(dst->FORM.Enum.SupportedValue[0]) *
                   src->FORM.Enum.NumberOfValues);
        for (i = 0; i < src->FORM.Enum.NumberOfValues; i++)
            duplicate_PropertyValue(&src->FORM.Enum.SupportedValue[i],
                                    &dst->FORM.Enum.SupportedValue[i],
                                    src->DataType);
        break;
    case PTP_DPFF_None:
        break;
...
static inline int ptp_unpack_OPD(PTPParams *params, unsigned char *data,
                                 PTPObjectPropDesc *opd, unsigned int opdlen) {
    unsigned int offset = 0, ret;
    ...
    ret = ptp_unpack_DPV(params, data, &offset, opdlen,
                         &opd->FactoryDefaultValue, opd->DataType);
    if (!ret)
        goto outofmemory;
    ...
    case PTP_OPFF_Range:
        ...
        if (!ret)
            goto outofmemory;
        ret = ptp_unpack_DPV(params, data, &offset, opdlen,
                             &opd->FORM.Range.StepSize, opd->DataType);
        if (!ret)
            goto outofmemory;
        break;
...
#define N opd->FORM.Enum.NumberOfValues
        ...
        opd->FORM.Enum.SupportedValue =
            malloc(N * sizeof(opd->FORM.Enum.SupportedValue[0]));
        if (!opd->FORM.Enum.SupportedValue)
            goto outofmemory;

        memset(opd->FORM.Enum.SupportedValue, 0,
...
static inline uint32_t ptp_pack_DPV(PTPParams *params, PTPPropertyValue *value,
                                    unsigned char **dpvptr, uint16_t datatype) {
    ...
    case PTP_DTC_AUINT8:
        ...
        for (i = 0; i < value->a.count; i++)
            htod8a(&dpv[sizeof(uint32_t) + i * sizeof(uint8_t)],
                   value->a.v[i].u8);
        break;
    case PTP_DTC_AINT8:
        ...
        htod32a(dpv, value->a.count);
        for (i = 0; i < value->a.count; i++)
            htod8a(&dpv[sizeof(uint32_t) + i * sizeof(int8_t)],
                   value->a.v[i].i8);
        break;
    case PTP_DTC_AUINT16:
        ...
        htod32a(dpv, value->a.count);
        for (i = 0; i < value->a.count; i++)
            htod16a(&dpv[sizeof(uint32_t) + i * sizeof(uint16_t)],
                    value->a.v[i].u16);
        break;
    case PTP_DTC_AINT16:
        ...
        htod32a(dpv, value->a.count);
        for (i = 0; i < value->a.count; i++)
            htod16a(&dpv[sizeof(uint32_t) + i * sizeof(int16_t)],
                    value->a.v[i].i16);
        break;
    case PTP_DTC_AUINT32:
        ...
        htod32a(dpv, value->a.count);
        for (i = 0; i < value->a.count; i++)
            htod32a(&dpv[sizeof(uint32_t) + i * sizeof(uint32_t)],
                    value->a.v[i].u32);
        break;
    case PTP_DTC_AINT32:
        ...
        htod32a(dpv, value->a.count);
        for (i = 0; i < value->a.count; i++)
            htod32a(&dpv[sizeof(uint32_t) + i * sizeof(int32_t)],
                    value->a.v[i].i32);
        break;
    case PTP_DTC_AUINT64:
        ...
        htod32a(dpv, value->a.count);
        for (i = 0; i < value->a.count; i++)
            htod64a(&dpv[sizeof(uint32_t) + i * sizeof(uint64_t)],
                    value->a.v[i].u64);
        break;
    case PTP_DTC_AINT64:
        ...
        htod32a(dpv, value->a.count);
        for (i = 0; i < value->a.count; i++)
            htod64a(&dpv[sizeof(uint32_t) + i * sizeof(int64_t)],
                    value->a.v[i].i64);
        break;
    /* XXX: other int types are unimplemented */
    case PTP_DTC_STR: {
...
static inline uint32_t ptp_pack_OPL(PTPParams *params, MTPProperties *props,
                                    int nrofprops, unsigned char **opldataptr) {
    ...
    while (nrofprops-- && noitems < MAX_MTP_PROPS) {
        ...
        packedpropslens[noitems] =
            ptp_pack_DPV(params, &propitr->propval, &packedprops[noitems],
                         propitr->datatype);
...
static int _compare_func(const void *x, const void *y) {
...
static inline int ptp_unpack_OPL(PTPParams *params, unsigned char *data,
                                 MTPProperties **pprops, unsigned int len) {
    ...
    for (i = 0; i < prop_count; i++) {
        if (len <= 0) {
            ptp_debug(params,
                      "short MTP Object Property List at property %d (of %d)",
                      i, prop_count);
        ...
        offset = 0;
        ptp_unpack_DPV(params, data, &offset, len, &props[i].propval,
                       props[i].datatype);
        data += offset;
        len -= offset;
    }
...
static inline void ptp_unpack_EC(PTPParams *params, unsigned char *data,
                                 PTPContainer *ec, unsigned int len) {
    unsigned int length;
    int type;
    ...
    if (length > len) {
        ptp_debug(params, "length %d in container, but data only %d bytes?!",
                  length, len);
        return;
    }
    ...
    if (type != PTP_USB_CONTAINER_EVENT) {
        ptp_debug(
            params,
            "Unknown canon event type %d (code=%x,tid=%x), please report!",
            type, ec->Code, ec->Transaction_ID);
        return;
    }
...
static inline void ptp_unpack_Canon_FE(PTPParams *params, unsigned char *data,
...
static inline void ptp_unpack_Canon_EOS_FE(PTPParams *params,
                                           unsigned char *data,
                                           PTPCANONFolderEntry *fe) {
    int i;
...
static inline uint16_t ptp_unpack_EOS_ImageFormat(PTPParams *params,
                                                  unsigned char **data) {
    /*
      EOS ImageFormat entries (of at least the 5DM2 and the 400D) look like
      this:
            ...
            uint32: image size (0 == Large, 1 == Medium, 2 == Small, 0xe == S1,
      0xf == S2, 0x10 == S3)
            uint32: image compression (2 == Standard/JPG, 3 == Fine/JPG, 4 ==
      Lossles/RAW)
      ...
      The idea is to simply 'condense' these values to just one uint16 to be
      able to conveniently
      use the available enumeration facilities (look-up table). The image size
      and compression
      values fully describe the image format. Hence we generate a uint16 with
      the four nibles set
      as follows: entry 1 size | entry 1 compression | entry 2 size | entry 2
      compression.
      The above example would result in the value 0x1400.

      The EOS 5D Mark III (and possibly other high-end EOS as well) added the
      extra fancy S1, S2
      and S3 JPEG options. S1 replaces the old Small. -1 the S1/S2/S3 to prevent
      the 0x10 overflow.
      */
    ...
    if (n != 1 && n != 2) {
        ptp_debug(
            params,
            "parsing EOS ImageFormat property failed (n != 1 && n != 2: %d)",
            n);
        return 0;
    }
    ...
    if (l != 0x10) {
        ptp_debug(params,
                  "parsing EOS ImageFormat property failed (l != 0x10: 0x%x)",
                  l);
        return 0;
    }
    ...
    *data = (unsigned char *)d + 4;
    ...
    return ((s1 & 0xF) << 12) | ((c1 & 0xF) << 8) | ((s2 & 0xF) << 4) |
           ((c2 & 0xF) << 0);
}

static inline uint32_t ptp_pack_EOS_ImageFormat(PTPParams *params,
                                                unsigned char *data,
                                                uint16_t value) {
...
static inline char *ptp_unpack_EOS_CustomFuncEx(PTPParams *params,
                                                unsigned char **data) {
    uint32_t s = dtoh32a(*data);
    uint32_t n = s / 4, i;
    char *str = (char *)malloc(
        s * 2 + s / 4 +
        1); /* n is size in uint32, maximum %x len is 8 chars and \0*/
    if (!str)
        return str;
    char *p = str;
...
static inline int ptp_unpack_CANON_changes(PTPParams *params,
                                           unsigned char *data, int datasize,
                                           PTPCanon_changes_entry **pce) {
    int i = 0, entries = 0;
    ...
    while (curdata - data < datasize) {
        ...
        case PTP_EC_CANON_EOS_ObjectAddedEx:
            ...
            ce[i].u.object.oi.StorageID =
                dtoh32a(&curdata[PTP_ece_OA_StorageID]);
            ce[i].u.object.oi.ParentObject =
                dtoh32a(&curdata[PTP_ece_OA_Parent]);
            ce[i].u.object.oi.ObjectFormat = dtoh16a(&curdata[PTP_ece_OA_OFC]);
            ce[i].u.object.oi.ObjectCompressedSize =
                dtoh32a(&curdata[PTP_ece_OA_Size]);
            ce[i].u.object.oi.Filename =
                strdup(((char *)&curdata[PTP_ece_OA_Name]));
            ptp_debug(params, "event %d: objectinfo added oid %08lx, parent "
                              "%08lx, ofc %04x, size %d, filename %s",
                      i, ce[i].u.object.oid, ce[i].u.object.oi.ParentObject,
        ...
        case PTP_EC_CANON_EOS_RequestObjectTransfer:
            ...
            ce[i].u.object.oi.ObjectCompressedSize =
                dtoh32a(&curdata[PTP_ece_OI_Size]);
            ce[i].u.object.oi.Filename =
                strdup(((char *)&curdata[PTP_ece_OI_Name]));

            ptp_debug(params, "event %d: request object transfer oid %08lx, "
                              "ofc %04x, size %d, filename %p",
                      i, ce[i].u.object.oid, ce[i].u.object.oi.ObjectFormat,
                      ce[i].u.object.oi.ObjectCompressedSize,
                      ce[i].u.object.oi.Filename);
            break;
        case PTP_EC_CANON_EOS_AvailListChanged: { /* property desc */
            ...
            ptp_debug(params, "event %d: EOS prop %04x desc record, datasize "
                              "%d, propxtype %d",
                      i, proptype, size - PTP_ece_Prop_Desc_Data, propxtype);
            for (j = 0; j < params->nrofcanon_props; j++)
                if (params->canon_props[j].proptype == proptype)
                    break;
            if (j == params->nrofcanon_props) {
                ptp_debug(params,
                          "event %d: propdesc %x, default value not found.", i,
                          proptype);
                break;
            }
            ...
            if (propxtype != 3) {
                ptp_debug(params,
                          "event %d: propxtype is %x for %04x, unhandled.", i,
                          propxtype, proptype);
            ...
            ptp_debug(params, "event %d: propxtype is %x, prop is 0x%04x, data "
                              "type is 0x%04x, propxcnt is %d.",
            ...
            dpd->FORM.Enum.SupportedValue =
                malloc(sizeof(PTPPropertyValue) * propxcnt);
            ...
            case PTP_DPC_CANON_EOS_ImageFormatExtHD:
                ...
                for (j = 0; j < propxcnt; j++) {
                    ...
                    ptp_debug(params, "event %d: suppval[%d] of %x is 0x%x.", i,
                              j, proptype,
                              dpd->FORM.Enum.SupportedValue[j].u16);
                }
                break;
...
#define XX(TYPE, CONV)                                                         \
    for (j = 0; j < propxcnt; j++) {                                           \
        ...
        ptp_debug(params, "event %d: suppval[%d] of %x is 0x%x.", i, j,        \
                  proptype, CONV(xdata));                                      \
...
#undef XX
                default:
                    ptp_debug(params, "event %d: data type 0x%04x of %x "
                                      "unhandled, raw values:",
                              i, dpd->DataType, proptype, dtoh32a(xdata));
                    for (j = 0; j < (size - PTP_ece_Prop_Desc_Data) / 4;
                         j++, xdata += 4) /* 4 is good for propxtype 3 */
        ...
        case PTP_EC_CANON_EOS_PropValueChanged:
            if (size >= 0xc) { /* property info */
                ...
                ptp_debug(params,
                          "event %d: EOS prop %04x info record, datasize is %d",
                          i, proptype, size - PTP_ece_Prop_Val_Data);
                for (j = 0; j < params->nrofcanon_props; j++)
                    if (params->canon_props[j].proptype == proptype)
                        break;
                if (j < params->nrofcanon_props) {
                    if ((params->canon_props[j].size != size) ||
                        (memcmp(params->canon_props[j].data, xdata,
                                size - PTP_ece_Prop_Val_Data))) {
                        params->canon_props[j].data =
                            realloc(params->canon_props[j].data,
                                    size - PTP_ece_Prop_Val_Data);
                        memcpy(params->canon_props[j].data, xdata,
                               size - PTP_ece_Prop_Val_Data);
                    }
                } else {
                    if (j)
                        params->canon_props =
                            realloc(params->canon_props,
                                    sizeof(params->canon_props[0]) * (j + 1));
                    else
                        params->canon_props =
                            malloc(sizeof(params->canon_props[0]));
                    params->canon_props[j].type = type;
                    params->canon_props[j].proptype = proptype;
                    params->canon_props[j].size = size;
                    params->canon_props[j].data =
                        malloc(size - PTP_ece_Prop_Val_Data);
                    memcpy(params->canon_props[j].data, xdata,
                           size - PTP_ece_Prop_Val_Data);
                    memset(&params->canon_props[j].dpd, 0,
...
#undef XX
                ...
                case PTP_DPC_CANON_EOS_StroboFiring:
                    ...
                    break;
                /* enumeration for AEM is never provided, but is available to
                 * set */
                ...
                case PTP_DPC_CANON_EOS_ExpCompensation: /* actually int8 if you
                                                           calculate */
                ...
                case PTP_DPC_CANON_EOS_WhiteBalanceAdjustB:
                    ...
                    break;
                /* unknown props, listed from dump.... all 16 bit, but vals
                 * might be smaller */
                case PTP_DPC_CANON_EOS_DPOFVersion:
                    dpd->DataType = PTP_DTC_UINT16;
                    ptp_debug(params, "event %d: Unknown EOS property %04x, "
                                      "datasize is %d, using uint16",
                              i, proptype, size - PTP_ece_Prop_Val_Data);
                ...
                case PTP_DPC_CANON_EOS_CustomFunc11:
                    dpd->DataType = PTP_DTC_UINT8;
                    ptp_debug(params, "event %d: Unknown EOS property %04x, "
                                      "datasize is %d, using uint8",
                              i, proptype, size - PTP_ece_Prop_Val_Data);
                    for (j = 0; j < size - PTP_ece_Prop_Val_Data; j++)
                        ptp_debug(params, "    %d: %02x", j, xdata[j]);
                    /* custom func entries look like this on the 400D: '5 0 0 0
                     * ?' = 4 bytes size + 1 byte data */
                    xdata += 4;
                    break;
                ...
                case PTP_DPC_CANON_EOS_Brightness:
                    dpd->DataType = PTP_DTC_UINT32;
                    ptp_debug(params, "event %d: Unknown EOS property %04x, "
                                      "datasize is %d, using uint32",
                              i, proptype, size - PTP_ece_Prop_Val_Data);
                    if ((size - PTP_ece_Prop_Val_Data) % sizeof(uint32_t) != 0)
                        ptp_debug(params, "event %d: Warning: datasize modulo "
                                          "sizeof(uint32) is not 0: ",
                                  i, (size - PTP_ece_Prop_Val_Data) %
                                         sizeof(uint32_t));
                    for (j = 0;
                         j < (size - PTP_ece_Prop_Val_Data) / sizeof(uint32_t);
                         j++)
                        ptp_debug(params, "    %d: 0x%8x", j,
                                  ((uint32_t *)xdata)[j]);
                    break;
                /* ImageFormat properties have to be ignored here, see special
                 * handling below */
                case PTP_DPC_CANON_EOS_ImageFormat:
                case PTP_DPC_CANON_EOS_ImageFormatCF:
                case PTP_DPC_CANON_EOS_ImageFormatSD:
                ...
                default:
                    ptp_debug(
                        params,
                        "event %d: Unknown EOS property %04x, datasize is %d",
                        i, proptype, size - PTP_ece_Prop_Val_Data);
                    for (j = 0; j < size - PTP_ece_Prop_Val_Data; j++)
                        ptp_debug(params, "    %d: %02x", j, xdata[j]);
                    break;
                ...
                case PTP_DTC_UINT32:
                    ...
                    ptp_debug(params, "event %d: currentvalue of %x is %x", i,
                              proptype, dpd->CurrentValue.u32);
                    break;
                case PTP_DTC_INT16:
                    dpd->FactoryDefaultValue.i16 = dtoh16a(xdata);
                    dpd->CurrentValue.i16 = dtoh16a(xdata);
                    ptp_debug(params, "event %d: currentvalue of %x is %d", i,
                              proptype, dpd->CurrentValue.i16);
                    break;
                case PTP_DTC_UINT16:
         ...
         */
...
#endif
                    ptp_debug(params, "event %d: currentvalue of %x is %s", i,
                              proptype, dpd->CurrentValue.str);
                    break;
                }
                default:
                ...
                /* ImageFormat and customFuncEx special handling (WARNING: dont
                 * move this in front of the dpd->DataType switch!) */
                switch (proptype) {
                case PTP_DPC_CANON_EOS_ImageFormat:
                case PTP_DPC_CANON_EOS_ImageFormatCF:
                case PTP_DPC_CANON_EOS_ImageFormatSD:
                case PTP_DPC_CANON_EOS_ImageFormatExtHD:
                    dpd->DataType = PTP_DTC_UINT16;
                    dpd->FactoryDefaultValue.u16 =
                        ptp_unpack_EOS_ImageFormat(params, &xdata);
                    dpd->CurrentValue.u16 = dpd->FactoryDefaultValue.u16;
                    ptp_debug(params, "event %d: decoded imageformat, "
                                      "currentvalue of %x is %x",
                ...
                case PTP_DPC_CANON_EOS_CustomFuncEx:
                    ...
                    dpd->CurrentValue.str =
                        strdup((char *)dpd->FactoryDefaultValue.str);
                    ptp_debug(params, "event %d: decoded custom function, "
                                      "currentvalue of %x is %s",
                              i, proptype, dpd->CurrentValue.str);
                    break;
                }
        ...
        case PTP_EC_CANON_EOS_OLCInfoChanged: {
            ...
            ptp_debug(params, "event %d: EOS event OLCInfoChanged (size %d)", i,
                      size);
            ...
            if (mask & CANON_EOS_OLC_SHUTTERSPEED) {
                ...
                if (j == params->nrofcanon_props)
                    ptp_debug(
                        params,
                        "event %d: shutterspeed not found yet, handle this", i);

                dpd = &params->canon_props[j].dpd;
                dpd->CurrentValue.u16 =
                    curdata[curoff + 5]; /* just use last byte */
            ...
            if (mask & CANON_EOS_OLC_APERTURE) {
                ...
                dpd = &params->canon_props[j].dpd;
                dpd->CurrentValue.u16 =
                    curdata[curoff + 4]; /* just use last byte */
            ...
            if (mask & CANON_EOS_OLC_ISO) {
                ...
                dpd = &params->canon_props[j].dpd;
                dpd->CurrentValue.u16 =
                    curdata[curoff + 3]; /* just use last byte */
            ...
            if (mask & 0x0010) {
                ...
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info =
                    malloc(strlen("OLCInfo event 0x0010 content 01234567") + 1);
                sprintf(ce[i].u.info,
                        "OLCInfo event 0x0010 content %02x%02x%02x%02x",
                        curdata[curoff], curdata[curoff + 1],
                        curdata[curoff + 2], curdata[curoff + 3]);
                curoff += 4;
                i++;
            }
            if (mask & 0x0020) {
                ...
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info = malloc(
                    strlen("OLCInfo event 0x0020 content 0123456789ab") + 1);
                sprintf(ce[i].u.info,
                        "OLCInfo event 0x0020 content %02x%02x%02x%02x%02x%02x",
                        curdata[curoff], curdata[curoff + 1],
                        curdata[curoff + 2], curdata[curoff + 3],
                        curdata[curoff + 4], curdata[curoff + 5]);
                curoff += 6;
                i++;
            }
            if (mask & 0x0040) {
                ...
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info = malloc(
                    strlen("OLCInfo event 0x0040 content 0123456789abcd") + 1);
                sprintf(
                    ce[i].u.info,
                    "OLCInfo event 0x0040 content %02x%02x%02x%02x%02x%02x%02x",
                    curdata[curoff], curdata[curoff + 1], curdata[curoff + 2],
                    curdata[curoff + 3], curdata[curoff + 4],
                    curdata[curoff + 5], curdata[curoff + 6]);
                curoff += 7;
                i++;
            }
            if (mask & 0x0080) {
                ...
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info =
                    malloc(strlen("OLCInfo event 0x0080 content 01234567") + 1);
                sprintf(ce[i].u.info,
            ...
            if (mask & 0x0100) {
                /* mask 0x0100: 6 bytes, 00 00 00 00 00 00 (before focus) and 00
                 * 00 00 00 01 00 (on focus) observed */
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info = malloc(
                    strlen("OLCInfo event 0x0100 content 0123456789ab") + 1);
                sprintf(ce[i].u.info,
                        "OLCInfo event 0x0100 content %02x%02x%02x%02x%02x%02x",
                        curdata[curoff], curdata[curoff + 1],
                        curdata[curoff + 2], curdata[curoff + 3],
                        curdata[curoff + 4], curdata[curoff + 5]);
                curoff += 6;
            ...
            if (mask & 0x0200) {
                ...
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info = malloc(
                    strlen("OLCInfo event 0x0200 content 0123456789abcd") + 1);
                sprintf(
                    ce[i].u.info,
                    "OLCInfo event 0x0200 content %02x%02x%02x%02x%02x%02x%02x",
                    curdata[curoff], curdata[curoff + 1], curdata[curoff + 2],
                    curdata[curoff + 3], curdata[curoff + 4],
                    curdata[curoff + 5], curdata[curoff + 6]);
                curoff += 7;
            ...
            if (mask & 0x0400) {
                ...
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info = malloc(
                    strlen("OLCInfo event 0x0400 content 0123456789abcd") + 1);
                sprintf(
                    ce[i].u.info,
            ...
            if (mask & 0x0800) {
                /* mask 0x0800: 8 bytes, 00 00 00 00 00 00 00 00 and 19 01 00 00
                 * 00 00 00 00 and others observed */
                /*   might be mask of focus points selected */
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info = malloc(
                    strlen("OLCInfo event 0x0800 content 0123456789abcdef") +
                    1);
                sprintf(ce[i].u.info, "OLCInfo event 0x0800 content "
                                      "%02x%02x%02x%02x%02x%02x%02x%02x",
                        curdata[curoff], curdata[curoff + 1],
                        curdata[curoff + 2], curdata[curoff + 3],
                        curdata[curoff + 4], curdata[curoff + 5],
                        curdata[curoff + 6], curdata[curoff + 7]);
                curoff += 8;
                i++;
            }
            if (mask & 0x1000) {
                ...
                ce[i].type = PTP_CANON_EOS_CHANGES_TYPE_UNKNOWN;
                ce[i].u.info =
                    malloc(strlen("OLCInfo event 0x1000 content 01") + 1);
        ...
        case PTP_EC_CANON_EOS_CameraStatusChanged:
            ...
            ptp_debug(params,
                      "event %d: EOS event CameraStatusChanged (size %d) = %d",
                      i, size, dtoh32a(curdata + 8));
        ...
        default:
            switch (type) {
#define XX(x)                                                                  \
    case PTP_EC_CANON_EOS_##x:                                                 \
        ptp_debug(params, "event %d: unhandled EOS event " #x " (size %d)", i, \
                  size);                                                       \
        ce[i].u.info =                                                         \
            malloc(strlen("unhandled EOS event " #x " (size 123456789)"));     \
...
static inline void ptp_unpack_Nikon_EC(PTPParams *params, unsigned char *data,
                                       unsigned int len, PTPContainer **ec,
                                       unsigned int *cnt) {
    unsigned int i;
    ...
    *ec = malloc(sizeof(PTPContainer) * (*cnt));
    ...
    for (i = 0; i < *cnt; i++) {
        ...
        (*ec)[i].Code =
            dtoh16a(&data[PTP_nikon_ec_Code + PTP_nikon_ec_Size * i]);
        (*ec)[i].Param1 =
            dtoh32a(&data[PTP_nikon_ec_Param1 + PTP_nikon_ec_Size * i]);
        (*ec)[i].Nparam = 1;
    }
}

static inline uint32_t ptp_pack_EK_text(PTPParams *params,
                                        PTPEKTextParams *text,
                                        unsigned char **data) {
    int i, len = 0;
    uint8_t retlen;
    unsigned char *curdata;

    len = 2 * (strlen(text->title) + 1) + 1 + 2 * (strlen(text->line[0]) + 1) +
          1 + 2 * (strlen(text->line[1]) + 1) + 1 +
          2 * (strlen(text->line[2]) + 1) + 1 +
          2 * (strlen(text->line[3]) + 1) + 1 +
          2 * (strlen(text->line[4]) + 1) + 1 + 4 * 2 + 2 * 4 + 2 + 4 + 2 +
          5 * 4 * 2;
    *data = malloc(len);
    if (!*data)
        return 0;
...
ptp_unpack_canon_directory(PTPParams *params, unsigned char *dir, uint32_t cnt,
...
#define ISOBJECT(ptr) (dtoh32a((ptr) + ptp_canon_dir_storageid) == 0xffffffff)
    ...
    *flags = calloc(sizeof((*flags)[0]), nrofobs);
    ...
    for (i = 0; i < cnt; i++) {
        ...
        oi->CaptureDate = oi->ModificationDate =
            dtoh32a(cur + ptp_canon_dir_unixtime);
        ...
        for (i = 0; i < cnt; i++) {
            ...
            for (j = 0; j < handles->n; j++)
                if (oid == handles->Handler[j])
                    break;
            if (j == handles->n) {
                /*fprintf(stderr,"did not find oid in lookup pass for current
                 * oid\n");*/
                continue;
            }
            ...
            if (nextoid != 0xffffffff) {
                for (j = 0; j < handles->n; j++)
                    if (nextoid == handles->Handler[j])
                        break;
                if (j == handles->n) {
                    /*fprintf(stderr,"did not find oid in lookup pass for next
                     * oid\n");*/
                    continue;
                }
